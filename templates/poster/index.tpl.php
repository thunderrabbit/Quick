                ...
                <form action="/commit/" id="commit" class="mainForm" method="POST">
                    <fieldset>
                        ...
                        <div class="PageRow noborder">
                            ...
                            <div class="PageInput">
                                <input id="commit_message" type="text" name="commit_message" size="50" value="Update via web interface" />
                                <div class="note">
                                    <strong>Note:</strong> The actual commit message will be generated by NextStoryWord, 
                                    which creates messages based on a story file and previous git commits. 
                                    Your message above will be recorded but not used as the actual git commit message.
                                </div>
                            </div>
                            <div class="fix"></div>
                        </div>
